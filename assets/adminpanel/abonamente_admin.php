               ...
               with font-awesome or any other icon font library -->
                            ...
                            <li class="nav-item menu-open">
                                ...
                                <ul class="nav nav-treeview">
                                    ...
                                    <li class="nav-item">
                                        <a href="abonamente_admin.php" class="nav-link active">
                                            <i class="far fa-circle nav-icon"></i>
                                            <p>Abonamente</p>
                                        </a>
                                    </li>
                ...
                <tbody>
                    ...
                    if ($resultCheck > 0) {
                        while ($row = mysqli_fetch_assoc($result)) {
                            ...
                            echo "<tr><td>" . $row["id"] . "</td><td>" . $row["user_id"] . "</td><td>" . $user_name . "</td><td>" . $row["payment_id"] .  "</td><td>" . $row["recurrence"] . "</td><td>" . $row["subscription_plan"] . "</td><td>" . $row["date_start"] . "</td><td>" . $row["date_end"] . "</td><td><a href='../php/delete.php?id=" . $row["id"] . "&tablename=subscription'>Delete</a>/<a href='../php/edit_subscription.php?id=" . $row["id"] . "&tablename=subscription'>Edit</a></td></tr>";
                        }
                    }
