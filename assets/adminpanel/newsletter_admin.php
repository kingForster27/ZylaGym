               ...
               with font-awesome or any other icon font library -->
                            ...
                            <li class="nav-item menu-open">
                                ...
                                <ul class="nav nav-treeview">
                                    ...
                                    <li class="nav-item">
                                        <a href="newsletter_admin.php" class="nav-link active">
                                            <i class="far fa-circle nav-icon"></i>
                ...
                <tbody>
                    ...
                    if ($resultCheck > 0) {
                        while ($row = mysqli_fetch_assoc($result)) {
                            echo "<tr><td>" . $row["id"] . "</td><td>" . $row["email"] . "</td><td>" . $row["date"] . "</td><td><a href='../php/delete.php?id=" . $row["id"] . "&tablename=newsletter'>Delete</a></td></tr>";
                        }
                    }
