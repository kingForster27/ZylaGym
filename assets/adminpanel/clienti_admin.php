               ...
               with font-awesome or any other icon font library -->
                            ...
                            <li class="nav-item menu-open">
                                ...
                                <ul class="nav nav-treeview">
                                    <li class="nav-item">
                                        <a href="clienti_admin.php" class="nav-link active">
                ...
                <tbody>
                    ...
                    if ($resultCheck > 0) {
                        while ($row = mysqli_fetch_assoc($result)) {
                            echo "<tr><td>" . $row["id"] . "</td><td>" . $row["name"] . "</td><td>" . $row["email"] . "</td><td>" . $row["phone_number"] . "</td><td>" . $row["password"] . "</td><td><a href='../php/delete.php?id=" . $row["id"] . "&tablename=user_data'>Delete</a>/<a href='../php/edit_user.php?id=" . $row["id"] . "&tablename=user_data'>Edit</a></td></tr>";
                        }
                    }
